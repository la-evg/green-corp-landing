...
class Bubble {
    ...
    getCanvasSize() {
        this.getCanvasWidth = this.canvas.clientWidth;
        this.getCanvasHeight = this.canvas.clientHeight;
    }
    ...
    init() {
        ...
        this.translateX = generateDecimalBetween(0, this.getCanvasWidth);
        this.translateY = generateDecimalBetween(0, this.getCanvasHeight)
    ...
    move() {
        ...
        if (this.translateY < 0 || this.translateX < 0 || this.translateX > this.canvasWidth) {
            this.init();
            this.translateY = this.getCanvasHeight;
        }
    }
}
